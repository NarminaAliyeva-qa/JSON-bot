...
bot = TeleBot(token='6587922229:AAEFvBcrGSmbMAbZ-nYvu3XNwSrkMBDltio', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я помогу тебе проверить JSON', # текст сообщения
    )
